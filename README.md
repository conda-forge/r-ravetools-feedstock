...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-ravetools-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-ravetools-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-ravetools
# for installing globally
pixi global install r-ravetools
```
...
It is possible to list all of the versions of `r-ravetools` available on your platform:
...
```
pixi search r-ravetools --channel conda-forge
```
